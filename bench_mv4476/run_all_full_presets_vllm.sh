...
PRESET=kimi2.6/tp8tp8/moonshotai-kimi-k2.6-amd-mi300x-tp8-moe-tp8.yaml bash run_all.sh
...
################# ENABLE CUDA GRAPH
# ### DP8EP8
PRESET=kimi2.6/tp8tp8/CG-Full-moonshotai-kimi-k2.6-amd-mi300x-tp8-moe-tp8.yaml bash run_all.sh
