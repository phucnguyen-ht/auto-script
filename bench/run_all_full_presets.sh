...
####### TP8
## Enable mtp, bs=64
ENFORCE_EAGER_PROFILE=0 RUN_PROFILE=0 PRESET=glm5/tp8/TP8-CG-zai-org-glm-5-fp8-amd-mi325x-dp8-moe-tp8-0ic-bs64-dg.yaml    bash run_all.sh
ENFORCE_EAGER_PROFILE=0 RUN_PROFILE=0 PRESET=glm5/tp8/TP8-CG-zai-org-glm-5-fp8-amd-mi325x-dp8-moe-tp8-0ic-bs64-moreh.yaml    bash run_all.sh
