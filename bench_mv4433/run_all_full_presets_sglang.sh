...
# RUN_PROFILE=0 RUN_BENCH=0 RUN_READABLE=1 PRESET=deepseek/dp8ep8/same_as_glm5_deepgemm.yaml  bash run_all.sh
# RUN_PROFILE=0 RUN_BENCH=0 RUN_READABLE=1 PRESET=deepseek/dp8ep8/same_as_glm5_moreh.yaml     bash run_all.sh
